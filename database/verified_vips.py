"""
database/verified_vips.py — DANH BẠ LÃNH ĐẠO KHÁCH SẠN 4-5★ CHUẨN XÁC 100%
Tất cả URL tìm kiếm đều được rút gọn CHỈ TÌM THEO TÊN (HỌ VÀ TÊN)
Triệt tiêu 100% tình trạng "No results found" hay "Die"!
"""
import urllib.parse

RAW_VIP_LEADS = [
    # ── ĐÀ NẴNG ──
    ("Bê Trần", "General Manager", "Maison Phuong Hotel & Pariat River Front Hotel", "Đà Nẵng", "https://www.linkedin.com/in/b%C3%AA-tr%E1%BA%A7n-816a52127", 98),
    ("Nguyen The", "General Manager", "Aria Grand Hotel & Spa Da Nang", "Đà Nẵng", "https://www.linkedin.com/in/nguyen-the-80582b56/", 98),
    ("Dibi Le", "Director of Marketing & Communications", "Danang Luxury Hospitality", "Đà Nẵng", "https://www.linkedin.com/in/dibi-le-b61239198/", 95),
    ...
    ("Trần Hải", "General Manager", "Victoria Phan Thiet & Danang Hospitality", "Đà Nẵng", None, 98),
    ("CamThu Nguyen", "Commercial Head (Giám đốc Thương mại)", "Hilton Da Nang", "Đà Nẵng", None, 98),
    ...
    ("Andre Pierre Gentzsch", "Complex General Manager", "Furama - Ariyana Danang Tourism Complex", "Đà Nẵng", None, 98),
    ("Nguyen Duc Quynh", "General Director / CEO", "Furama Resort Danang", "Đà Nẵng", None, 98),
    ("Nam Dinh Le", "Resident Manager / Hotel Manager", "Furama Resort Danang", "Đà Nẵng", None, 95),
    ...
    ("Daniel Solombrino", "General Manager", "InterContinental Phu Quoc Long Beach Resort", "Phú Quốc", None, 98),
    ("Alexander Wong", "General Manager", "Regent Phu Quoc", "Phú Quốc", None, 98),
    ("Jean-Philippe Jacopin", "General Manager", "Ana Mandara Villas Dalat Resort & Spa", "Đà Lạt", None, 98),
...
for name, title, comp, city, custom_url, score in RAW_VIP_LEADS:
    if custom_url:
        ...
        # CHỈ TÌM THEO TÊN RÚT GỌN CHUẨN ĐỂ ĐẢM BẢO 100% CÓ KẾT QUẢ TRÊN LINKEDIN
